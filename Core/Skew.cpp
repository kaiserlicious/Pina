...
THIS::THIS(Document* d, TiXmlHandle h):Element(d,h){
  ...
  if(element){
    Utils::fromString(skew,element->GetText());
  }
...
void THIS::order(){ children.sort(Ordering<Types>()); } const std::string THIS::Name = "skew";
...
TiXmlElement* THIS::toTiXmlElement(){
  ...
  TiXmlText* text = new TiXmlText(Utils::toString(skew));
