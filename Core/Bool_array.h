...
#ifndef COLLADA_BOOL_ARRAY_H
#define COLLADA_BOOL_ARRAY_H
...
/**
@brief Describes an array of booleans
*/
class THIS: public Element{
 ...
 ~THIS();
  ...
  std::vector<bool>::const_reference operator [](unsigned int i) const{
    return values[i];
  }
