...
THIS::THIS(Document* d, TiXmlHandle h):Element(d,h){
  ...
  if(element){
    Utils::fromString(rotation,element->GetText());
  }
...
void THIS::order(){ children.sort(Ordering<Types>()); } const std::string THIS::Name = "rotate";
...
TiXmlElement* THIS::toTiXmlElement(){
  ...
  TiXmlText* text = new TiXmlText(Utils::toString(rotation));
